VideoPlayerApp.controller('VideoPlayerController', function ($scope, $http,$sce, $rootScope, $location, $timeout) {
    // Allow the drag and drop video to Playlist

    $scope.dropUploadVideo = function (data, evt, plId, plName) {
        console.log(data, evt, plId);
        ...
        $scope.playlistChooseByDrag = {
          "id": plId,
          "name": plName
        };
        $("#drop-drag-upload").modal();
    };
